...
BUILD_URL_WIN = "https://github.com/acierto-incomodo/content_warning/releases/latest/download/Build.zip"
BUILD_URL_LINUX = "https://github.com/acierto-incomodo/content_warning/releases/latest/download/Build.zip"
VERSION_URL = "https://github.com/acierto-incomodo/content_warning/releases/latest/download/Version.txt"
RELEASE_NOTES_URL = "https://github.com/acierto-incomodo/content_warning/releases/latest/download/ReleaseNotes.txt"

EXE_NAME_WIN   = "Build/Content Warning.exe"
EXE_NAME_LINUX = "Build/Content Warning.exe"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Content Warning Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("Content Warning")
